...
class RadiationToolbox:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('RadiationToolbox', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/RadiationToolbox//icons/{}.png'.format(
            'safecast_icon_stable' if PLUGIN_TYPE == PluginType.Safecast else 'radiation_toolbox_icon'
        )
        self.add_action(
            icon_path,
            text=PLUGIN_NAME,
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = RadiationToolboxDockWidget()
