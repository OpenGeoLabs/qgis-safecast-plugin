...
<qgis version="2.14.0-Essen" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="ADER_microSvh" forceraster="0" symbollevels="0" type="graduatedSymbol" graduatedMethod="GraduatedColor" enableorderby="0">
    <ranges>
      ...
      <range render="true" symbol="2" lower="0.100000000000000" upper="0.150000000000000" label="0.10 - 0.15"/>
      <range render="true" symbol="3" lower="0.150000000000000" upper="0.200000000000000" label="0.15 - 0.20"/>
      <range render="true" symbol="4" lower="0.200000000000000" upper="0.250000000000000" label="0.20 - 0.25"/>
      <range render="true" symbol="5" lower="0.250000000000000" upper="0.300000000000000" label="0.25 - 0.30"/>
      <range render="true" symbol="6" lower="0.300000000000000" upper="0.500000000000000" label="0.30 - 0.50"/>
      <range render="true" symbol="7" lower="0.500000000000000" upper="1.000000000000000" label="0.50 - 1.00"/>
      <range render="true" symbol="8" lower="1.000000000000000" upper="5.000000000000000" label="1.00 - 5.00"/>
    </ranges>
    <symbols>
    ...
    <colorramp type="gradient" name="[source]">
      <prop k="color1" v="0,0,127,255"/>
      <prop k="color2" v="170,0,0,255"/>
      <prop k="discrete" v="0"/>
      <prop k="stops" v="0.25;0,170,255,255:0.5;85,255,127,255:0.75;255,170,0,255"/>
    </colorramp>
